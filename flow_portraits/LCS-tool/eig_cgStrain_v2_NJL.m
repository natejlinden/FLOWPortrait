%% ORIGINAL CODE FROM LCS-Tool-master Haller et al. (ETH Zurich http://ETHZ.CH)
% Adapted for FLOW portraits by Nate Linden
...
function varargout = eig_cgStrain_v2_NJL(derivative,domain,resolution,timespan,varargin)

% nargoutchk(1,2); %% ORINIGNAL CODE %%

% ------------------------------------------------------------------------------------- %
% Nate Linden change 2019/08
nargoutchk(1,3); % 3 outputs 
% ------------------------------------------------------------------------------------- %
...
% ------------------------------------------------------------------------------------- %
%% NATE Linden CHANGE 2019/08 
% need to check if greater than 2 output argutments
...
% ------------------------------------------------------------------------------------- %
%% Nate Linden change
%% Store Cauchy-Green strain tensor to output
            cgStrainOUT = cgStrainMainGrid;
% ------------------------------------------------------------------------------------- %
...
% ------------------------------------------------------------------------------------- %
%% Nate Linden change
%% Add additional case to handle 3rd output arg
    case 3
        [cgStrainD,cgStrainV] = negative_to_nan(cgStrainD,cgStrainV);
% ------------------------------------------------------------------------------------- %
    otherwise
